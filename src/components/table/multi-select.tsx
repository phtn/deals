...
export const MultiSelect = <T,>({
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      setActionError(
        'The selected rows could not be deleted. Please try again.',
      )
    }
  }
  ...
  return (
    <div className='flex h-full min-h-0 flex-col bg-background/70'>
                      ...
                      <TableCell className={cn('py-0', {hidden: isCompact})}>
                        <div className='flex flex-col'>
                          {field.inputKind === 'select' ? (
                            <Select
                              defaultValue={draftValues[field.id]}
                              onValueChange={(value) =>
                            ...
                            <input
                              ...
                              step={
                                field.inputKind === 'number' ? 'any' : undefined
                              }
      ...
      <Drawer open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
        <DrawerContent className='border border-border/60 bg-background/95 shadow-2xl'>
            ...
            <div className='rounded-xl border border-rose-500/20 bg-rose-500/8 px-4 py-3'>
              <div className='flex items-start gap-3'>
                <div className='mt-0.5 rounded-full bg-rose-500/12 p-2 text-rose-600 dark:text-rose-300'>
                  <Icon name='trash-delete-fill' className='size-4' />
                </div>
                <div className='min-w-0'>
...
const buildUpdatePayload = <T,>(
  ...
  return pendingFieldUpdates.reduce(
    (updates, {field, value}) => {
