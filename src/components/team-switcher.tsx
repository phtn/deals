...
export function TeamSwitcher({teams}: TeamSwitcherProps) {
  const [, setActiveTeam] = React.useState(teams[0] ?? null)
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              ...
              <div className='flex h-8 items-center justify-center rounded-lg overflow-hidden dark:bg-gradient-to-br from-slate-600/80 via-slate-600/40 to-sidebar-primary/20 text-sidebar-primary-foreground relative after:rounded-[inherit] after:absolute after:inset-0 after:shadow-[0_0_1px_0_rgb(0_0_0/.05),inset_0.4px_0.4px_0.6px_0.0_rgb(255_255_255/.25)] after:pointer-events-none'>
                <span className='px-1 font-semibold'>BestDeal</span>
              ...
              <Icon
                name='chevron-right'
                className='rotate-90 size-4 text-sidebar-foreground/50'
              />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
