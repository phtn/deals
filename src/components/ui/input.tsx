  ...
  return (
    <input
      ...
      className={cn(
        ...
        'focus-visible:border-ring focus-visible:bg-sidebar/40 focus-visible:ring-0',
    ...
    return (
      <div className='flex items-center space-x-2'>
        <input
          ...
          ref={ref}
          className={cn(
            'flex md:h-14 h-10 w-full rounded-lg px-3 py-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm text-xs shadow-2xs',
            ' bg-background dark:bg-background/80 border border-origin dark:border-zinc-700',
