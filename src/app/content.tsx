...
export const Content = () => {
  ...
  const { sequence, currentStep, isCorrect, handleClick, message } =
    useSequence();
  ...
  return (
    <div className="flex items-start justify-center">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="space-y-10 bg-gradient-to-br from-neutral-50/60 via-neutral-50 to-neutral-50/40 backdrop-blur-lg size-[28rem] rounded-[4.5rem] flex flex-col items-center justify-center">
            <div className="h-12 border-b border-neutral-300 w-full flex items-center justify-between px-8">
              <div className="flex items-center space-x-4">
                <TextAnimate
                  delay={0.8}
                  type="whipInUp"
                  className="h-12 font-semibold font-figtree tracking-tighter text-2xl"
                >
                  BestDeal
                </TextAnimate>
                <span className="font-light tracking-wider h-10 uppercase">
                  Dashboard
                </span>
              </div>
              <span className="text-sm tracking-tight h-9 text-emerald-500">
                {message}
              </span>
              {/*<span className="text-xs tracking-wider opacity-80 font-medium h-6 text-orange-600">
                ADMIN
              </span>*/}
            </div>
                ...
                {isCorrect && (
                  ...
                  >
                    <div className="h-40 flex flex-col items-center">
                      <Button rightIcon="google" size="lg" variant="dark">
                      ...
                      <div className="h-20 flex items-center justify-center w-full whitespace-nowrap space-x-2 px-2">
                        <Icon name="lock" className="size-3 opacity-60" />
